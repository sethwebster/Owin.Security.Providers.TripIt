...
namespace Microsoft.Owin.Security.TripIt
{
    ...
    public class TripItAuthenticatedContext : BaseContext
    {
        ...
        public TripItAuthenticatedContext(IOwinContext context, JObject user, string accessToken, string expires)
            : base(context)
        {
            User = user;
        ...
        /// <summary>
        /// Gets the TripIt access token expiration time
        /// </summary>
        ...
        /// <summary>
        /// Gets the TripIt username
        /// </summary>
        public string UserName { get; private set; }

        /// <summary>
        /// Gets the TripIt email
        /// </summary>

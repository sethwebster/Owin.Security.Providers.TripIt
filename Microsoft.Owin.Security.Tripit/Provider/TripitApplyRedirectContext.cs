...
{
    /// <summary>
    /// Context passed when a Challenge causes a redirect to authorize endpoint in the TripIt middleware
    /// </summary>
    public class TripItApplyRedirectContext : BaseContext<TripItAuthenticationOptions>
    {
        /// <summary>
        /// Creates a new context object.
        /// </summary>
        /// <param name="context">The OWIN request context</param>
        /// <param name="options">The TripIt middleware options</param>
        ...
        public TripItApplyRedirectContext(IOwinContext context, TripItAuthenticationOptions options,
